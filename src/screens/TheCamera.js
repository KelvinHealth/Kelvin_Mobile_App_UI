...
function TheCamera({navigation}) {
        ...
        <View style={styles.root}>
          <View style={styles.bg163}>
            <View style={styles.button2Row}>
              ...
              <Text style={styles.experimentalPopMusicSession2}>The Camera</Text>
            </View>
          </View>
          <Text
            style={
          ...
          <View style={styles.kelvinCam1}>
            <View style={styles.cacc2927074A4C918E3C383Ec436Abb4}>
              <Image
                source={require("../assets/images/9618244d55b4d4d3a5c60ea0e204b9986d0f7881.png")}
                resizeMode="cover"
                style={styles.efa315Bec4D778B8E55D7E1689C97}
              ></Image>
            </View>
          </View>
        </View>
    ...
    const styles = StyleSheet.create({
      ...
      cacc2927074A4C918E3C383Ec436Abb4: {
        width: 295,
        height: 215,
        backgroundColor: "transparent",
        opacity: 1,
