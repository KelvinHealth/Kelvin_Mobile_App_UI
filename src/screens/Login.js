        ...
        <View style={styles.root}>
          ...
          >
            <View style={styles.bg12}>
              <Text style={styles.verify}>LOGIN</Text>
            </View>
          </TouchableOpacity>
          ...
          <View style={styles.bg15}>
            <View style={styles.button2Row}>
              ...
              <View style={styles.experimentalPopMusicSessionStack}>
                <Text style={styles.experimentalPopMusicSession}>Login</Text>
                <Svg
          ...
          <View style={styles.group2}>
            ...
            ></TextInput>
            <Svg viewBox="-1 -1 315 4.009998321533203" style={styles.line3012}>
              <Path
                strokeWidth={2}
                fill="transparent"
                stroke="rgba(129,120,137,1)"
